...
// 1. Peschiamo i dati base di Axel dal registro
const baseInfo = characterRegistry.find(char => char.id === "axelBlazeIEJapan");

export const charData = {
    // 2. Uniamo i dati base (importa automaticamente name, thumb, element, position, ecc.)
    ...baseInfo,
    tags: [
    ...
    // Queste chiavi devono corrispondere a quelle presenti in js/Techniques/library.js
    myTechniques: ["ファイアトルネード", "爆熱スクリュー"],

    // Questi ID devono corrispondere a quelli presenti in js/Passive/library.js
    myPassivesIds: ["100000101", "103010001", "103010003", "100000501", "103010004"]
};